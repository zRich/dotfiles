...
M.govim = function()
  map("n", "<leader>4", "<cmd> :GoDebugStart <CR>")
  map("n", "<leader>9", "<cmd> :GoDebugBreakpoint <CR>")
  map("n", "<leader>5", "<cmd> :GoDebugContinue <CR>")
  map("n", "<leader>10", "<cmd> :GoDebugStepOver <CR>")
  map("n", "<leader>11", "<cmd> :GoDebugStepInto <CR>")
  map("n", "<leader>3", "<cmd> :GoDebugStop <CR>")
...
M.godebug = function()
  ...
  map("n", "<leader>10", ":lua require('dap').step_over()<CR>")
  map("n", "<leader>11", ":lua require('dap').step_into()<CR>")
