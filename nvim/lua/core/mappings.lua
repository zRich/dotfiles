...
M.govim = function()
  map("n", "<F4>", "<cmd> :GoDebugStart <CR>")
  map("n", "<F9>", "<cmd> :GoDebugBreakpoint <CR>")
  map("n", "<F5>", "<cmd> :GoDebugContinue <CR>")
  map("n", "<F10>", "<cmd> :GoDebugStepOver <CR>")
  map("n", "<F11>", "<cmd> :GoDebugStepInto <CR>")
...
M.godebug = function()
  ...
  map("n", "<F1>", ":lua require('dap.ui.widgets').hover()<CR>")
